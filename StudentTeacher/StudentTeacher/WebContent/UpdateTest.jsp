    ...
    <div class="container-fluid text-center">    
      <div class="row content">
        ...
        <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Edit Question ID To be changed" name="queid" required id="queid">
              </div>
              
              <div class="form-group">
                <label for="optionA">Edit Option A</label>
                <input type="text" class="form-control" placeholder="Edit Option A" name="optionA" required id="optionA">
              </div>
  
              <div class="form-group">
                  <label for="optionB">Edit Option B</label>
                  <input type="text" class="form-control" placeholder="Edit Option B" name="optionB" required id="optionB">
              </div>
              
              <div class="form-group">
                  <label for="optionC">Edit Option C</label>
                  <input type="text" class="form-control" placeholder="Edit Option C" name="optionC" required id="optionC">
              </div>
              
              <div class="form-group">
                  <label for="optionD">Edit Option D</label>
                  <input type="text" class="form-control" placeholder="Edit Option D" name="optionD" required id="optionD">
              </div>
