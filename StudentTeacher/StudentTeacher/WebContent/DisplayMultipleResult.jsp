        ...
        <div class="col-sm-2 sidenav">
		  ...
		  <tbody>
		    ...
		    <% for(int i=0; i<multiple.size(); i++){ %>
		      <th scope="row"><% out.println(multiple.get(i).getStudentid()); %></th>
		      <td><% out.println(multiple.get(i).getName()); %></td>
		      <td><% out.println(multiple.get(i).getUsername()); %></td>
		      <td><% out.println(multiple.get(i).getResult()); %></td>
		    </tr>
		    <% }%>
		  </tbody>
		</table>
