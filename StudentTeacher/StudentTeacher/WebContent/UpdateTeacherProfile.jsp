        ...
        <h3>Update Teacher Profile</h3>
          <form action="UpdateTeacherProfile" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter Username" name="tusername" required id="tusername">
            </div>
    
            <div class="form-group">
              <label for="toldpassword">Old Password</label>
              <input type="password" class="form-control" placeholder="Enter Old Password" name="toldpassword" required id="toldpassword">
            </div>
                
            <div class="form-group">
              <label for="tnewpassword">New Password</label>
              <input type="password" class="form-control" placeholder="Enter New Password" name="tnewpassword" required id="tnewpassword">
            </div>
