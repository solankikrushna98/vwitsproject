      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
              <li class="nav-item"><a class="nav-link" href="StudentHomepage.jsp">Home</a></li>
          ...
          <div class="container">
            ...
            <form action="UpdateStudentProfile" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Username" name="susername" required id="susername">
                </div>
    
                <div class="form-group">
                    <label for="soldpassword">Old Password</label>
                    <input type="password" class="form-control" placeholder="Enter Old Password" name="soldpassword" required id="soldpassword">
                </div>
                
                <div class="form-group">
                    <label for="snewpassword">New Password</label>
                    <input type="password" class="form-control" placeholder="Enter New Password" name="snewpassword" required id="snewpassword">
                </div>
