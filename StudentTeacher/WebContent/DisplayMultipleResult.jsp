  ...
  <body>
	...
	if(username == null){
		out.println("Session Invalid");
			...
			List<Student> multiple = (List)request.getAttribute("multiple");
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
		     ...
		     <li class="nav-item active"><a class="nav-link" href="DisplayResult">Display All Results</a></li>
            ...
            <div class="card-body text-center">
              <p class="card-text">Student ID</p>
                <% for(int i=0; i<multiple.size(); i++){ %>
                  <p class="card-text"><% out.println(multiple.get(i).getStudentid()); %></p>
                <% }%>
            </div>
          </div>
          <div class="card bg-primary">
            <div class="card-body text-center">
              <p class="card-text">Student Name</p>
                <% for(int i=0; i<multiple.size(); i++){ %>
                  <p class="card-text"><% out.println(multiple.get(i).getName()); %></p>
               <% }%>
            </div>
          </div>
          <div class="card bg-primary">
            <div class="card-body text-center">
                <p class="card-text">Student Username</p>
                  <% for(int i=0; i<multiple.size(); i++){ %>
                    <p class="card-text"><% out.println(multiple.get(i).getUsername()); %></p>
                 <% }%>
            </div>
        </div>
        <div class="card bg-primary">
            <div class="card-body text-center">
                <p class="card-text">Student Result</p>
                  <% for(int i=0; i<multiple.size(); i++){ %>
                    <p class="card-text"><% out.println(multiple.get(i).getResult()); %></p>
                 <% }%>
            </div>
          </div>
      </div>
