        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            <li class="nav-item"><a class="nav-link" href="AdminHomepage.jsp">&nbsp;<span class="glyphicon glyphicon-home"></span></a></li>
		     <li class="nav-item active"><a class="nav-link" href="DisplayTeachers">Display Teachers</a></li>
		     <li class="nav-item"><a class="nav-link" href="DisplayStudents">Display Students</a></li>
		 ...
		 <table class="table">
		  <thead class="thead-dark">
		    <tr>
		      ...
		      <th>
		      	<a href="TeacherRegistration.jsp" class="btn btn-info btn-sm">
		  ...
		  <tbody>
		    ...
		    <% for(int i=0; i<list.size(); i++){ %>
		      ...
		      <td>
		      	<a href="deleteTeacher?teacherid=<%=list.get(i).getTeacherid()%>">
